...
e5ce3ca39356   mysql:8.0   "docker-entrypoint.s…"   2 minutes ago   Up 2 minutes   0.0.0.0:3306->3306/tcp, 33060/tcp   mysql-docker
$ docker exec -it mysql-docker bash
root@e5ce3ca39356:/# mysql -u root -p test_db < /tmp/test_dump.sql
Enter password:
root@e5ce3ca39356:/#
```
...
```bash
root@e5ce3ca39356:/# mysql -u root -p
Enter password: 
...
Threads: 2  Questions: 13  Slow queries: 0  Opens: 118  Flush tables: 3  Open tables: 37  Queries per second avg: 0.024
--------------
...
```bash
root@e5ce3ca39356:/# cat /etc/mysql/my.cnf
