...
```commandline
root@ea6a19fde6da:/# psql -U root -d test_database
```
**- список БД**
```commandline
test_database=# \l
...
### Ответ:
```commandline
root@ea6a19fde6da:/# psql -U postgres -d test_database -f /test_data/test_dump.sql 
SET
SET
SET
SET
...
### Ответ:
```commandline
 root@ea6a19fde6da:/# pg_dump -U postgres -d test_database >/test_data/test_database_dump.sql
```
